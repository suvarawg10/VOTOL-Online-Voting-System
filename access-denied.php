  ...
  <section id="testimonials" class="hoc container clear"> 
    ...
    <ul class="nospace group">
      <li class="one_half">
		...
		<div class="err"  style="color:#D60505; text-align: center;"><h1><b>Access Denied!</b></h1></div>
		  <p>You don't have access to this resource.<br> <a href="login.php">Click here</a> to login first.</p>
		</div>
		</blockquote>
