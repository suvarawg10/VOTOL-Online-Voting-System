...
if (isset($_POST['Submit']))
{
	...
	$flag=mysqli_query($conn,"SET @num := 0;")
	 or die(mysqli_error()); 
	 $flag=mysqli_query($conn,"UPDATE tbcandidates SET candidate_id = @num := (@num+1);")
	 or die(mysqli_error()); 
	 $flag=mysqli_query($conn,"ALTER TABLE tbcandidates AUTO_INCREMENT = 1;")
	 or die(mysqli_error()); 
